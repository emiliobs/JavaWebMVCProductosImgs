...
<html>
    ...
    <body  style="background-color: #016075;">
        <div class="container " style=" align-content: center; margin-right:  -130px;  margin-top: 150px;">
            <form action="ProductoSV?accion=Guardar" method="post" enctype="multipart/form-data">
                <div class="card col-md-6">
                    ...
                    <div class="card-footer " style="text-align: center;">
                        <button type="submit" class="btn btn-outline-info" style="font-style: italic; font-weight: bold; color: red;" name="accion">Guardar!</button>
                    </div>
                </div>
            </form>
